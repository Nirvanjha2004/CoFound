// shared gsap setup for the landing scroll stories
// scrolltrigger has to be registered once or the whole pin thing gets weird
...
// tiny helper when u just need reduce motion awareness
